...
<div class="alert alert-danger rouge h1 text-center mt-3 mb-3" role="alert">
    <p>Champs Invalide ,Veuillez vérifier le formulaire ! </p>
</div>
<?php endif; ?>

<div id='inscriptionID' class="container-fluid montain">
    <div class="col-md-10 m-auto">
        <form class='formEvent m-auto' method="post" action="">
            <div class="row text-center justify-content-center mt-1 text-white">
                <div class="col-12 text-white p-3 mt-5 mb-5">
                    <legend class='mb-5 mt-3 h1 montserrat' style='border-bottom: 1rem groove;'>Création d'un évènement</legend>
                
                    <div class="form-group">
                        <label class="control-label montserrat" for="location">Adresse :</label>
                        <input class="form-control w-75 m-auto <?=$isSubmitted && isset($errors['location']) ? 'is-invalid' : ''?>"
                            value="<?=$location?>" id="location" name="location" type="text" placeholder="29 rue gu grand boulevards">
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto"><?=$errors['location'] ?? ""?></div>
                    </div>
                    ...
                    <div>
                        <label for="ville_code_postal">Code postal : </label>
                         ...
                         <div class="invalid-feedback bg-danger w-50 text-white m-auto"><?=$errors['ville_code_postal'] ?? ""?></div>
                    </div>
                    <div>
                        <label for="ville_nom">Ville : </label>
                        <select name="ville_nom" id="ville_nom">
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto"><?=$errors['ville_nom'] ?? ""?></div>
                            <option value=""></option>
                        </select>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="budget"
                            class="form-control w-75 m-auto  <?=$isSubmitted && isset($errors['budget']) ? 'is-invalid' : ''?>" id="
                        budget">
                        ...
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto bg-danger w-50 text-white m-auto"><?=$errors['budget'] ?? ""?></div>
                    </div>

                    <div class="form-group">
                        <label for="maxParticipant" class='montserrat'>Participant maximum</label>
                        <select name="maxParticipant"
                            class="form-control w-75 m-auto  <?=$isSubmitted && isset($errors['maxParticipant']) ? 'is-invalid' : ''?>" id="
                        maxParticipant">
                            ...
                            <option <?=$maxParticipant == 11 ? 'selected' : ''?> value="11">Entre 10 et 15 personnes</option>
                            <option <?=$maxParticipant == 12 ? 'selected' : ''?> value="12">Entre 15 et 20 personnes</option>
                            <option <?=$maxParticipant == 13 ? 'selected' : ''?> value="13">Entre 20 et 30 personnes</option>
                            <option <?=$maxParticipant == 14 ? 'selected' : ''?> value="14">Entre 30 et 50 personnes</option>
                        </select>
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto bg-danger w-50 text-white m-auto"><?=$errors['maxParticipant'] ?? ""?></div>
                    </div>

                    <div class="form-group">
                        <label for="difficulty" class='montserrat'>Difficulté</label>
                        <select name="difficulty"
                            class="form-control w-75 m-auto  <?=$isSubmitted && isset($errors['difficulty']) ? 'is-invalid' : ''?>" id="
                        difficulty">
                        ...
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto bg-danger w-50 text-white m-auto"><?=$errors['difficulty'] ?? ""?></div>
                    </div>

                    <div class="form-group">
                        <label class="control-label montserrat" for="dateOfEvents">Date de l'évènement :</label>
                        <input class="form-control w-75 m-auto  <?=$isSubmitted && isset($errors['dateOfEvents']) ? 'is-invalid' : ''?>"
                            value="<?=$dateOfEvents?>" id="dateOfEvents" type="date" name="dateOfEvents" placeholder="25/01/2021">
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto"><?=$errors['dateOfEvents'] ?? ""?></div>
                    </div>

                    <div class="form-group">
                        <label for="typeOfEvents" class='montserrat'>Catégorie de l'évènement</label>
                        <select name="typeOfEvents"
                            class="form-control w-75 m-auto  <?=$isSubmitted && isset($errors['typeOfEvents']) ? 'is-invalid' : ''?>" id="
                        typeOfEvents">
                            <option>Sélectionner le niveau de difficulté :</option>
                        ...
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto bg-danger w-50 text-white m-auto"><?=$errors['typeOfEvents'] ?? ""?></div>
                    </div>

                    <div>
                        <label for="activityOfEvents"> Activité de l'évènement : </label>
                        <select name="activityOfEvents" id="activityOfEvents">
                        <div class="invalid-feedback bg-danger w-50 text-white m-auto"><?=$errors['activityOfEvents'] ?? ""?></div>
                            <option value=""></option>
                        </select>
                    </div>
                    ...
                    <div class="text-center"> <button type="submit" class="btn btn-warning " name='create'>Créér l'évènement!</button></div>
                </div>
        </form>
</div>
