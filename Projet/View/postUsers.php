        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <div class="col-12 text-center">
                    <h2 class="card-text jaune montserrat noirBackground">Profil de : <span
                            class='text-white'><?= $usersPostInfo->pseudo; ?></span></h2>
                </div>

                <div class="col-12 text-center mt-3">
                    <?php if (isset($_GET['users_id']) && ($usersPostInfo->photo != '')) : ?>
                    <img class="img-fluid p-2 w-25" style="border-radius:50%;"
                        src="<?= PICT_FOLDER.'pict-'.$usersPostInfo->users_id.'.'.$usersPostInfo->photo; ?>"
                        alt="profile picture">
                    <?php else: ?>
                    <img class="img-fluid p-2 w-25" style="border-radius:50%;" src="../assets/img/avatar.jpg"
                ...
                <div class="col-12 text-center mt-3">
                    <form action="" method='POST'>
                        <div class="col-12 text-center mt-4">
                            <label for="contentPost text-white montserrat"><span
                                    class='text-white montserrat h5 border-bottom'>Votre commentaire pour
                                    <?= $usersPostInfo->pseudo; ?> : </span></label>
                        </div>
