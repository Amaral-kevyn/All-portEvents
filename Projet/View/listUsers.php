    ...
    <div class="row justify-content-around">
        ...
        <?php if (count($usersList) > 0) { 
            ...
            <div class="card-body bg-light text-center border rounded border-info">
                ...
                <?php                
        if (isset($_SESSION['user']) && ($user->photo != NULL )): ?>
                <img class="img-fluid w-50 mb-3" style="border-radius:50%;"
                    src="<?= PICT_FOLDER.'pict-'.$user->users_id.'.'.$user->photo; ?>" alt="profile picture">
                <?php else: ?>
                <img class="img-fluid w-50 mb-3" style="border-radius:50%;" src="/assets/img/avatar.jpg"
                ...
                <p class="card-text orange montserrat noirBackground ">Age : <span class='text-white'>
                        <?= $user->age; ?></span></p>
                <p class="card-text orange montserrat noirBackground ">Département :<span class='text-white'>
                        <?= $user->department_id; ?></span></p>
